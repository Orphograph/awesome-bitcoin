...
* [Orphograph](https://orphograph.com) - Proof-of-existence notary anchoring SHA-256 fingerprints to Bitcoin via OpenTimestamps; single-file MIT MCP server lets AI agents anchor and verify receipts.
